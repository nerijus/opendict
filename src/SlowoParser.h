...
#ifndef SLOWO_PARSER_H
#define SLOWO_PARSER_H
...
class SlowoParser: public DictParser
{
   public:
      SlowoParser(const wxString &, const wxString&, wxStatusBar*);
      ~SlowoParser() { wxLogDebug(_T("[+] SlowoParser dead")); };
